...
const Departments = () => {
  ...
  const styles = {
    ...
    statCard: { backgroundColor: '#fff', padding: '24px', borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.02)', display: 'flex', alignItems: 'center', gap: '20px' },
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <button style={styles.addBtn} onClick={() => setIsModalOpen(true)}><Plus size={18} /> Add Department</button>
      </div>
      ...
      <div style={styles.contentCard}>
        ...
        <table style={styles.table}>
          <thead><tr><th style={styles.th}>ID</th><th style={styles.th}>Name</th><th style={styles.th}>Head</th><th style={styles.th}>Employees</th><th style={styles.th}>Status</th><th style={styles.th}>Budget (M)</th><th style={styles.th}>Actions</th></tr></thead>
          <tbody>
            {filtered.map(d => (
              <tr key={d.id}>
